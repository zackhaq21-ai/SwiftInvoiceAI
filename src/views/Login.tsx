...
const FACTS = [
  ...
  { emoji: '📱', stat: '60 seconds', detail: 'Most ThatInvoice users send their first invoice within 60 seconds of signing up.' },
        ...
        <div className="relative space-y-10">
          <div>
            ...
            <p className="text-slate-400 text-lg leading-relaxed max-w-sm">
              Speak a job, snap a photo, or type — ThatInvoice turns it into a professional invoice in seconds.
            </p>
          </div>
        ...
        <div className="relative flex-1 flex flex-col items-center justify-center px-6 py-10">
          <div className="w-full max-w-[380px]">
            ...
            <div className="flex flex-col items-center mb-8">
              ...
              <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">ThatInvoice</h1>
