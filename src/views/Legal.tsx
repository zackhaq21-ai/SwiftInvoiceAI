    ...
    sections: [
      {
        heading: 'Overview',
        body: [
          'Crewbill ("we", "us", "our") is an invoicing application that helps businesses create, send, and manage invoices, estimates, and payments. This Privacy Policy explains how we collect, use, and protect your information.',
          'By using Crewbill, you agree to the practices described in this policy.',
        ],
      },
      {
    ...
    sections: [
      {
        ...
        body: [
          'By creating an account or using Crewbill, you agree to these Terms of Service. If you do not agree, you may not use the service.',
      ...
      },
      {
        ...
        body: [
          'You agree to use Crewbill only for lawful business purposes. You may not use the service to create fraudulent invoices, misrepresent goods or services, or violate any applicable laws.',
      ...
      },
      {
        ...
        body: [
          'Crewbill offers Free, Pro ($14.99/mo), Business ($29.99/mo), and Enterprise ($99.99/mo) plans. Prices are in USD and billed monthly through Stripe.',
      ...
      },
      {
        ...
        body: [
          'Crewbill and its software, design, and branding are the property of their respective owners. You may not copy, modify, or redistribute the platform itself.',
      ...
      },
      {
        ...
        body: [
          'Crewbill is provided "as is" without warranties of any kind. We do not guarantee that the service will be error-free, uninterrupted, or that invoices generated through AI features will be legally compliant in your jurisdiction.',
    ...
    sections: [
      {
        ...
        body: [
          'You can cancel your Crewbill subscription at any time from your account settings or by contacting support.',
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-6 py-6 md:py-10 pb-20">
        ...
        <div className="mt-12 pt-8 border-t border-slate-200">
          ...
          <p className="text-xs text-slate-400 mt-6">
            &copy; {new Date().getFullYear()} Crewbill. All rights reserved.
          </p>
        </div>
      </div>
    </div>
