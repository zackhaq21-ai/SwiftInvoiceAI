...
export default function MobileBottomNav({ current, onNavigate, onCreate }: MobileBottomNavProps) {
  ...
  return (
    <nav
      className="md:hidden fixed bottom-0 left-0 right-0 z-40 mobile-dock safe-area-pb"
      aria-label="Primary navigation"
    >
      <div className="flex items-center justify-around px-2 h-[4.25rem] relative">
        ...
        <div className="flex flex-col items-center -mt-6">
          <button
            onClick={onCreate}
            className="w-14 h-14 rounded-[1.15rem] bg-gradient-to-br from-indigo-500 via-indigo-600 to-blue-600 text-white flex items-center justify-center shadow-xl shadow-indigo-600/35 ring-4 ring-white active:scale-90 transition-transform min-touch"
