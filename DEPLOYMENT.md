...
This document describes the deployment workflow for **velzico.com** using Bolt's built-in hosting.
...
2. Click **Update** to push your changes live to velzico.com.
...
```bash
bash scripts/post-deploy-health-check.sh https://velzico.com
```
